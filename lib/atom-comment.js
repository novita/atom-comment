...
export function activate() {
  disposables.push(atom.commands.add('atom-text-editor:not([mini])', { 'atom-comment:toggle': toggle }));
}
...
function toggle() {
  ...
  const padding = atom.config.get('atom-comment.pad') ? ' ' : '';
